...
import com.bc.jpa.DatabaseUpdaterImpl;
 ...
 */
public class SlaveUpdater extends DatabaseUpdaterImpl {
    
    public SlaveUpdater(
            PersistenceUnitContext masterContext, 
            PersistenceUnitContext slaveContext) {
        this(new MasterSlavePersistenceContextImpl(masterContext, slaveContext));
    }

    public SlaveUpdater(
            MasterSlavePersistenceContext masterSlaveContext) {
        super(masterSlaveContext.getSlaveOptional().get(), (e) -> true, masterSlaveContext);
    }
}
